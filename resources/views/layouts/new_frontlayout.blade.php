...
<html lang="en">
  ...
  <head>
    ...
    <!-- Custom css -->
    <link href="{{ asset('assets/front/css/custom.css?v=24.3') }}" rel="stylesheet">
    <!-- Owl Stylesheets -->
      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          ...
          <div id="navbar1" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              <li class=""><a href="{{route('about-us')}}">{{__('home.about') }}</a></li>
              <li class="dropdown">
                <a href="{{route('productsList',['slug' => 'packaging'])}}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">{{__('home.products_new') }} <span class="caret"></span></a>
                <ul class="dropdown-menu custom-dropdown-menu" role="menu">
                  <li><a href="{{route('productsList',['slug' => 'packaging'])}}" style="color: #0c6a35;">{{__('productdetails.packaging')}}</a></li>
                  <li><a href="{{route('productsList',['slug' => 'storage'])}}" style="color: #0c6a35;">{{__('productdetails.storage')}}</a></li>
                  <li><a href="{{route('productsList',['slug' => 'packaging-equipment'])}}" style="color: #0c6a35;">{{__('productdetails.equipment')}}</a></li>
                  <li><a href="{{route('productsList',['slug' => 'accessories'])}}" style="color: #0c6a35;">{{__('productdetails.accessories')}}</a></li>
                </ul>
              </li>
              
              <li class="dropdown">
                <a href="{{route('productsList',['slug' => 'packaging'])}}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">{{__('home.sustain') }}<span class="caret"></span></a>
                <ul class="dropdown-menu custom-dropdown-menu" role="menu">
                  <li><a href="{{route('sustainablity')}}" style="color: #0c6a35;">{{__('home.recycling') }}</a></li>
                  <li><a href="{{route('csr-activities')}}" style="color: #0c6a35;">{{__('home.initiatives') }}</a></li>
                </ul>
              </li>
              
              <!--<li><a href="{{route('new-landing')}}">Fresh Food Packaging</a></li>-->
            ...
            <div class="dropdown custom-dropdown show" style="width:277px;">
                ...
                <a href="{{route('new-landing')}}" class="eee" style="position: relative;">
                      <!--<div style="width: 35px;display: inline-block;position:absolute;right: -12px;top: -19px;">-->
                      <!--    <img src="{{ asset('assets/front/img/food-logo-white (1).gif')}}" alt="Cart Icon" class="img-responsive white-icons" style="height: 20px;">-->
                      <!--    <img src="{{ asset('assets/front/img/food-logo-green (1).gif')}}" alt="Cart Icon" class="img-responsive green-icons" style="height: 20px;">-->
                      <!--</div>-->
                    <img src="{{ asset('assets/front/img/fresh-food-white.png?v=0.1')}}" alt="Cart Icon" class="img-responsive white-icons">
        ...
        <!--/.container-fluid -->
            <div class="after-login-menu" id="afterLoginMenu" style="display: none;">
              <ul>
                <li><a href="{{ route('myOrders') }}"><i class="las la-shopping-cart"></i> {!! __('popup.My Orders') !!}</a></li>
                <li><a href="{{route('userLogout')}}"><i class="las la-sign-out-alt"></i>{!! __('popup.Logout') !!}</a></li>
              </ul>
            </div>
      </nav>
    </div>
...
<!-- <div class="nav-margin"></div> -->
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-md-offset-4 col-sm-6 col-xs-12 mb30">
        <div class="fot-box">
          <h4>{{__('home.menu')}}</h4>
          <ul class="half-uls">
            <li><a href="{{route('about-us')}}">{{__('home.about') }}</a></li>
            <li><a href="{{route('productsList',['slug' => 'packaging'])}}" class="link">{{__('home.products') }}</a></li>
            <li><a href="{{route('sustainablity')}}" class="link">{{__('home.sustain') }}</a></li>
            <li><a href="{{route('csr-activities')}}" class="link">{{__('home.initiatives') }}</a></li>
          </ul>
          <ul class="half-uls">
            <li><a href="{{route('blog')}}">{{__('home.blog') }}</a></li>
            <li><a href="{{route('contact')}}#enquiry-form">{{__('home.enquire') }}</a></li>
          </ul>
        </div>
      </div>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="below-footer">
          ...
          <div class="other-links">
            <ul>
              <li><a href="{{route('faq')}}">{{__('home.faqs') }}</a></li>
              <li><a href="{{route('privacy')}}">{{__('home.privacy') }}</a></li>
              <li><a href="{{route('refunds-and-returns')}}">{{__('home.refunds') }}</a></li>
              <li><a href="{{route('terms')}}">{{__('home.terms') }}</a></li>
  ...
  <img src="{{ asset('assets/front/img/footer-bg.png') }}" alt="Footer BG" class="footer-image-grass">
</footer>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="myNewModal">
          <div class="modal-dialog center" role="document">
            <div class="modal-content" style=" background-color: transparent !important; box-shadow: none;">
              ...
              <div class="modal-body" style="padding: 0px;">
                <a href="https://api.whatsapp.com/send?phone=918448848948" target="_blank"><img src="{{asset('assets/images/website.jpg')}}" class="img-responsive"></a>
              </div>
            </div>
          </div>
        </div>
