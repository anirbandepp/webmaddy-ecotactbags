...
@section('content')
  ...
  <div class="section">
    <div class="map-wrapper"><img src="{{asset('front-end/images/map.svg')}}" loading="lazy" width="35" alt="ecotactbags" class="map-img">
      ...
      <a data-toggle="tooltip" title= "PHILIPPINES" href="#MUNTINLUPA" class="pointer w-inline-block" style="left: 77%;bottom: 54.5%;"><img src="{{asset('front-end/images/Ecotact_Segregation-Re1-01-1.png')}}" loading="lazy" width="25" height="25" alt="ecotactbags" class="pointer-img" ></a>
      ...
      <a data-toggle="tooltip" title= "NEPAL" href="#KATHMANDU" class="pointer w-inline-block" style="left: 69%;bottom: 51.5%;"><img src="{{asset('front-end/images/Ecotact_Segregation-Re1-01-1.png')}}" loading="lazy" width="25" height="25" alt="ecotactbags" class="pointer-img" ></a>
      <a data-toggle="tooltip" title= "NETHERLANDS" href="#ALMERE" class="pointer w-inline-block" style="left: 17%;bottom: 47.5%;"><img src="{{asset('front-end/images/Ecotact_Segregation-Re1-01-1.png')}}" loading="lazy" width="25" height="25" alt="ecotactbags" class="pointer-img"></a>
    </div>
  </div>
        ...
        <div class="location-card static w-inline-block">
          ...
          <div class="content-block">
            <div class="location-content-container">
              <div class="address">{{@$hqb->company_name}},<br>{{strtoupper(@$hqb->house_no)}}</div>
              <div class="location-details-wrapper">
                <div class="details-wrapper"><img src="{{asset('front-end/images/Group.svg')}}" loading="lazy" alt="ecotactbags" class="image-16">
                  <div class="address">{{@$hqb->phone1}} @if(@$hqb->phone2) / @endif {{@$hqb->phone2}} </div>
                </div>
                <div class="details-wrapper"><img src="{{asset('front-end/images/Group-1.svg')}}" loading="lazy" alt="ecotactbags" class="image-16">
                  <div class="address"><a href="mailto:{{@$hqb->email1}}" style="color:rgba(0, 0, 0, 0.9);">{{@$hqb->email1}}</a> @if(@$hqb->email2) | @endif <a href="mailto:{{@$hqb->email2}}" style="color:rgba(0, 0, 0, 0.9);">{{@$hqb->email2}}</a></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div style="display:grid" class="w-layout-grid location-grid asia">
            @forelse($continent->branches as $branch)
                <div class="location-card w-inline-block">
                    ...
                    <div class="content-block">
                        <div class="location-main-wrapper">
                            <div class="location-icon"><img src="{{asset('front-end/images/location.svg')}}" loading="lazy" alt="ecotactbags">
                            </div>
                            <div class="location">
                              <div class="h3-wrapper contact">
                  ...
                  <div class="location-content-container">
                    ...
                    <div class="location-details-wrapper">
                        ...
                        <div class="details-wrapper">
                            @if(@$branch->email1)
                              <img src="{{asset('front-end/images/Group-1.svg')}}" loading="lazy" alt="ecotactbags" class="image-16">
                            <div class="address"><a href="mailto:{{@$branch->email1}}" style="color:rgba(0, 0, 0, 0.9);">{{@$branch->email1}}</a></div>
                            @else
